...
#        mkfs.vfat /dev/sda1
#        mkfs.ext4 /dev/sda2
#            mount /dev/sda1 /mnt && mkdir /mnt/boot/
#            mount /dev/sda2 /mnt/boot
cgdisk /dev/sda
#echo Going completley nuclear and erasing disks with MBR  root partition
#    parted --script /dev/sda mkpart primary ext4 201Mib 100% set 1 boot on
#        mkfs.ext4 /dev/sda1
#            mount /dev/sda1 /mnt
