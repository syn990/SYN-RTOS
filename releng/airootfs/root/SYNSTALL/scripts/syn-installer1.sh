...
FINAL_HOSTNAME990=SYN990-testbuild                                        #
#################################################################
...
echo Adding $FINAL_HOSTNAME990 to /etc/hostname
        ...
        touch /etc/issue            && echo 'SYN Syntax990 RTOS (arch) \r (\l)' >> /etc/issue
    ...
    useradd -m -G wheel -s /bin/zsh $DEFAULT_USER990
      passwd $DEFAULT_USER990
        ...
        mkdir /home/$DEFAULT_USER990/.local
            ...
            #strange, previous install this didn't happen and startx had default xinitrc etc?!?
