...
"The repository includes "SYN-RTOS-ARCHISOFILES", which is a profile for [archiso](https://wiki.archlinux.org/title/archiso) that allows you to implement any specific features you may need. At its core, the directory is a collection of text files (no executables) and serves as a template to create your own [Meta-Distribution](https://wiki.c2.com/?MetaDistribution) based on Arch Linux."
